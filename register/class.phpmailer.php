  ...
  protected function MailSend($header, $body) {
    ...
    if ($this->Sender != '' && strlen(ini_get('safe_mode'))< 1) {
      ...
      if ($this->SingleTo === true && count($toArr) > 1) {
        ...
        $rt = @mail($to, $this->EncodeHeader($this->SecureHeader($this->Subject),'text', 1), $body, $header);
      }
    }
    if (isset($old_from)) {
  ...
  */
  ...
  public function AddrFormat($addr) {
    if (empty($addr[1])) {
      ...
      return $this->EncodeHeader($this->SecureHeader($addr[1]), 'phrase',1) . " <" . $this->SecureHeader($addr[0]) . ">";
    }
  }
  ...
  */
  ...
  private function AttachAll() {
    ...
    foreach ($this->attachment as $attachment) {
      ...
      $mime[] = sprintf("Content-Type: %s; name=\"%s\"%s", $type, $this->EncodeHeader($this->SecureHeader($name),'text', 1), $this->LE);
      ...
      $mime[] = sprintf("Content-Disposition: %s; filename=\"%s\"%s", $disposition, $this->EncodeHeader($this->SecureHeader($name),'text', 1), $this->LE.$this->LE);
